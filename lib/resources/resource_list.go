...
// 2020-10-12 06:12:48.123596 +0200 CEST m=+0.001937530
package resources

var images = map[string]ImageEntry{
	// # (comiled with "find . -type f | sort | sed 's/^..//' > resource_files.csv")
	...
	"GEOGRAPH/UP_BORD1.SPK": {4, 320, 200, "", 0}, // Broken
	"GEOGRAPH/UP_BORD2.SCR": {1, 320, 200, "", 0},
	"GEOGRAPH/UP_BORD2.SPK": {4, 320, 200, "", 0}, // Broken
	"GEOGRAPH/UP_BORD3.SPK": {3, 320, 200, "", 0}, // Broken
	// GO.BAT
	// GO.COM
	// INTR.O
	// INTRO.EXE
